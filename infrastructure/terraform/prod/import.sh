...
echo ""
echo "NOTE: aws_iam_role.prod_github_frontend_deploy is a NEW resource."
echo "      It will be created (not imported) on first terraform apply."
echo ""
echo "NEXT STEP: Run 'terraform plan' — expect 2 changes to create (role + inline policy)."
echo "If other resources show diffs, update main.tf to match live config before applying."